      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a href="tel:5165559432" className="bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-5 rounded-xl hover:from-red-700 hover:to-orange-700 transition-all shadow-2xl text-center font-bold text-lg flex items-center justify-center gap-2 group">
